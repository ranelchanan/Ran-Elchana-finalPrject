...
public abstract class FirebaseRecyclerAdapter<T, VH extends RecyclerView.ViewHolder>
    ...
    public class CustomFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint.length() == 0) {
                ...
                return results;
                    ...
                    int backListsize = backupList.size();
                    int index = 0;
                    ...
                    for (T t : backupList) {
                        ...
                        if (index == (backListsize - 5)) {
                            Log.w(TAG, "finsih loop:" + Calendar.getInstance().getTime().toString());
                    ...
                    Log.w(TAG, "out:" + Calendar.getInstance().getTime().toString());
                    results.values = filteredList;
                    results.count = filteredList.size();


                    Log.w(TAG, "return time:" + Calendar.getInstance().getTime().toString());
                    return results;
                }
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            Log.w(TAG,"publishResults start time:" + Calendar.getInstance().getTime().toString());
            if (results.count != 0) {
